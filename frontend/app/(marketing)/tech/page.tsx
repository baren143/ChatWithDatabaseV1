...
export const metadata: Metadata = {
  title: "Tech Stack — PostgreSQL pgvector, FastAPI, Next.js",
  description: "Built with PostgreSQL pgvector for vector search, FastAPI backend, Next.js frontend, Celery workers, and NVIDIA NIM for AI embeddings and LLM inference.",
};
