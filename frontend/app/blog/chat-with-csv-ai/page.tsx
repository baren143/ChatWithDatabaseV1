    ...
    <div className="min-h-screen bg-[#07090e] text-white relative overflow-x-hidden font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-gray-300 leading-relaxed">
          <h1 className="text-3xl font-bold mb-6 text-white">How to Chat with Your CSV Files Using AI (No Coding Required)</h1><p>Learn how to upload CSV files and ask questions in plain English. AI-powered CSV analysis with instant answers, no SQL or Python needed.</p>
        </div>
