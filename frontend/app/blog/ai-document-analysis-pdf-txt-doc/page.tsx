    ...
    <div className="min-h-screen bg-[#07090e] text-white relative overflow-x-hidden font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-gray-300 leading-relaxed">
          <h1 className="text-3xl font-bold mb-6 text-white">AI Document Analysis: Chat with PDF, TXT, DOC and DOCX Files</h1><p>Upload PDF, TXT, DOC, and DOCX files for AI-powered analysis. Get summaries, extract insights from any document format instantly.</p>
        </div>
