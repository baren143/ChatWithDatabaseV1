    ...
    <div className="min-h-screen bg-[#07090e] text-white relative overflow-x-hidden font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-gray-300 leading-relaxed">
          <h1 className="text-3xl font-bold mb-6 text-white">How to Chat with Word (DOCX/DOC) Documents Using AI</h1><p>Upload Word documents and ask questions in plain English. AI-powered DOCX analysis with formatting preservation and instant answers.</p>
        </div>
