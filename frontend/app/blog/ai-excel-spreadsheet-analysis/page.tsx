    ...
    <div className="min-h-screen bg-[#07090e] text-white relative overflow-x-hidden font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-gray-300 leading-relaxed">
          <h1 className="text-3xl font-bold mb-6 text-white">How to Analyze Excel Spreadsheets with AI (Upload, Chat, Get Insights)</h1><p>Upload XLSX spreadsheets and analyze them with AI. Ask questions, get instant answers with row-level citations, no formulas needed.</p>
        </div>
