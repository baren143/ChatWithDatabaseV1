    ...
    <div className="min-h-screen bg-[#07090e] text-white relative overflow-x-hidden font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-gray-300 leading-relaxed">
          <h1 className="text-3xl font-bold mb-6 text-white">How to Query Your Database Using Plain English (Natural Language SQL)</h1><p>Turn natural language into database queries. Ask questions in English and get SQL-powered answers from any SQL database.</p>
        </div>
