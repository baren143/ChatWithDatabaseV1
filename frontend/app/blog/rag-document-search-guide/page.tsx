    ...
    <div className="min-h-screen bg-[#07090e] text-white relative overflow-x-hidden font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-gray-300 leading-relaxed">
          <h1 className="text-3xl font-bold mb-6 text-white">RAG-Powered Document Search: The Complete Guide to AI Document Chat</h1><p>Learn how RAG powers document chat. How AI finds answers across PDFs, CSVs, DOCX files and databases instantly with vector search.</p>
        </div>
